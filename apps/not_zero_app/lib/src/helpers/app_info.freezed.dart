...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String platform,  String version, @JsonKey(name: 'build')  int buildNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.name,_that.platform,_that.version,_that.buildNumber);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String platform,  String version, @JsonKey(name: 'build')  int buildNumber)  $default,) {final _that = this;
switch (_that) {
case _AppInfo():
return $default(_that.name,_that.platform,_that.version,_that.buildNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String platform,  String version, @JsonKey(name: 'build')  int buildNumber)?  $default,) {final _that = this;
switch (_that) {
case _AppInfo() when $default != null:
return $default(_that.name,_that.platform,_that.version,_that.buildNumber);case _:
  return null;

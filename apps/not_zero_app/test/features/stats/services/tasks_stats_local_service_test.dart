...
void main() {
  ...
  group('TasksStatsLocalService', () {
    ...
    test('should count created tasks in period', () async {
      ...
      await db.into(db.tasksTable).insert(Task(
            id: uuid.v4(),
            title: 'Task 1',
            description: '',
            createdAt: now,
    ...
    test('Day Edge: should NOT count task completed at next day 00:00:00', () async {
      ...
      expect(result.normal, 0, reason: 'Task at 00:00:00 next day should not be in Day 1');
    });
    ...
    test('Day Edge: should count task completed at 23:59:59', () async {
     ...
     test('Day Edge: Task exactly at endPeriod boundary (23:59:59.999)', () async {
      final day1 = DateTime(2023, 1, 1);

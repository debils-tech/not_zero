...
class _TranslationsCommonEn {
	...
	// Translations
	late final _TranslationsCommonDialogEn dialog = _TranslationsCommonDialogEn._(_root);
	late final _TranslationsCommonTimeSubtitleEn timeSubtitle = _TranslationsCommonTimeSubtitleEn._(_root);
	late final _TranslationsCommonCopyEn copy = _TranslationsCommonCopyEn._(_root);
	late final _TranslationsCommonTimeOptionsEn timeOptions = _TranslationsCommonTimeOptionsEn._(_root);
}
...
class _TranslationsSettingsEn {
	...
	// Translations
	late final _TranslationsSettingsListEn list = _TranslationsSettingsListEn._(_root);
	late final _TranslationsSettingsThemeEn theme = _TranslationsSettingsThemeEn._(_root);
	late final _TranslationsSettingsStorageEn storage = _TranslationsSettingsStorageEn._(_root);
...
class _TranslationsStatsEn {
	...
	// Translations
	late final _TranslationsStatsQuickViewEn quickView = _TranslationsStatsQuickViewEn._(_root);
}
...
class _TranslationsTagsEn {
	...
	// Translations
	late final _TranslationsTagsCreationEn creation = _TranslationsTagsCreationEn._(_root);
}
...
class _TranslationsSettingsListEn {
	...
	late final _TranslationsSettingsListBlocksEn blocks = _TranslationsSettingsListBlocksEn._(_root);
}
...
class _TranslationsSettingsThemeEn {
	...
	late final _TranslationsSettingsThemeValuesEn values = _TranslationsSettingsThemeValuesEn._(_root);
}
...
class _TranslationsSettingsStorageEn {
	...
	late final _TranslationsSettingsStorageImportStatusEn importStatus = _TranslationsSettingsStorageImportStatusEn._(_root);
	late final _TranslationsSettingsStorageExportStatusEn exportStatus = _TranslationsSettingsStorageExportStatusEn._(_root);
...
class _TranslationsSettingsAboutEn {
	...
	late final _TranslationsSettingsAboutBlocksEn blocks = _TranslationsSettingsAboutBlocksEn._(_root);
}
...
class _TranslationsTagsCreationEn {
	...
	// Translations
	late final _TranslationsTagsCreationTitleEn title = _TranslationsTagsCreationTitleEn._(_root);
	late final _TranslationsTagsCreationFieldsEn fields = _TranslationsTagsCreationFieldsEn._(_root);
	String get submit => 'Save';
	late final _TranslationsTagsCreationDeleteDialogEn deleteDialog = _TranslationsTagsCreationDeleteDialogEn._(_root);
	late final _TranslationsTagsCreationTooltipsEn tooltips = _TranslationsTagsCreationTooltipsEn._(_root);
}
...
class _TranslationsTasksListEn {
	...
	late final _TranslationsTasksListDeleteDialogEn deleteDialog = _TranslationsTasksListDeleteDialogEn._(_root);
	late final _TranslationsTasksListTooltipsEn tooltips = _TranslationsTasksListTooltipsEn._(_root);
}
...
class _TranslationsTasksViewEn {
	...
	late final _TranslationsTasksViewTooltipsEn tooltips = _TranslationsTasksViewTooltipsEn._(_root);
}
...
class _TranslationsTasksEditEn {
	...
	// Translations
	late final _TranslationsTasksEditTitleEn title = _TranslationsTasksEditTitleEn._(_root);
	late final _TranslationsTasksEditFieldsEn fields = _TranslationsTasksEditFieldsEn._(_root);
	late final _TranslationsTasksEditSubmitEn submit = _TranslationsTasksEditSubmitEn._(_root);
	late final _TranslationsTasksEditDeleteDialogEn deleteDialog = _TranslationsTasksEditDeleteDialogEn._(_root);
	late final _TranslationsTasksEditTooltipsEn tooltips = _TranslationsTasksEditTooltipsEn._(_root);
}

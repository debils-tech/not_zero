...
class TranslationsCommonEn {
  ...
  // Translations
  late final TranslationsCommonDialogEn dialog = TranslationsCommonDialogEn._(
    _root,
  );
  late final TranslationsCommonTimeSubtitleEn timeSubtitle =
      TranslationsCommonTimeSubtitleEn._(_root);
...
class TranslationsSettingsEn {
  ...
  // Translations
  late final TranslationsSettingsListEn list = TranslationsSettingsListEn._(
    _root,
  );
  late final TranslationsSettingsThemeEn theme = TranslationsSettingsThemeEn._(
    _root,
  );
  late final TranslationsSettingsStorageEn storage =
      TranslationsSettingsStorageEn._(_root);
  late final TranslationsSettingsAboutEn about = TranslationsSettingsAboutEn._(
    _root,
  );
}
...
class TranslationsStatsEn {
  ...
  // Translations
  late final TranslationsStatsQuickViewEn quickView =
      TranslationsStatsQuickViewEn._(_root);
}
...
class TranslationsTagsEn {
  ...
  // Translations
  late final TranslationsTagsCreationEn creation = TranslationsTagsCreationEn._(
    _root,
  );
}
...
class TranslationsSettingsListEn {
  ...
  late final TranslationsSettingsListBlocksEn blocks =
      TranslationsSettingsListBlocksEn._(_root);
}
...
class TranslationsSettingsThemeEn {
  ...
  late final TranslationsSettingsThemeUseDynamicColorsOptionEn
  useDynamicColorsOption = TranslationsSettingsThemeUseDynamicColorsOptionEn._(
    _root,
  );
  late final TranslationsSettingsThemeHarmonizeColorsEn harmonizeColors =
      TranslationsSettingsThemeHarmonizeColorsEn._(_root);
  late final TranslationsSettingsThemeValuesEn values =
      TranslationsSettingsThemeValuesEn._(_root);
}
...
class TranslationsSettingsStorageEn {
  ...
  late final TranslationsSettingsStorageImportStatusEn importStatus =
      TranslationsSettingsStorageImportStatusEn._(_root);
  late final TranslationsSettingsStorageExportStatusEn exportStatus =
      TranslationsSettingsStorageExportStatusEn._(_root);
...
class TranslationsSettingsAboutEn {
  ...
  late final TranslationsSettingsAboutBlocksEn blocks =
      TranslationsSettingsAboutBlocksEn._(_root);
}
...
class TranslationsTagsCreationEn {
  ...
  // Translations
  late final TranslationsTagsCreationTitleEn title =
      TranslationsTagsCreationTitleEn._(_root);
  late final TranslationsTagsCreationFieldsEn fields =
      TranslationsTagsCreationFieldsEn._(_root);

  /// en: 'Save'
  String get submit => 'Save';

  late final TranslationsTagsCreationDeleteDialogEn deleteDialog =
      TranslationsTagsCreationDeleteDialogEn._(_root);
  late final TranslationsTagsCreationTooltipsEn tooltips =
      TranslationsTagsCreationTooltipsEn._(_root);
}
...
class TranslationsTasksListEn {
  ...
  late final TranslationsTasksListDeleteDialogEn deleteDialog =
      TranslationsTasksListDeleteDialogEn._(_root);
  late final TranslationsTasksListTooltipsEn tooltips =
      TranslationsTasksListTooltipsEn._(_root);
  late final TranslationsTasksListAppBarActionsEn appBarActions =
      TranslationsTasksListAppBarActionsEn._(_root);
  ...
  String tasksLeftToComplete({required num n}) =>
      (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(
        n,
  ...
  late final TranslationsTasksListEmptyEn empty =
      TranslationsTasksListEmptyEn._(_root);
  late final TranslationsTasksListPlanningEn planning =
      TranslationsTasksListPlanningEn._(_root);
}
...
class TranslationsTasksViewEn {
  ...
  late final TranslationsTasksViewTooltipsEn tooltips =
      TranslationsTasksViewTooltipsEn._(_root);
}
...
class TranslationsTasksEditEn {
  ...
  // Translations
  late final TranslationsTasksEditTitleEn title =
      TranslationsTasksEditTitleEn._(_root);
  late final TranslationsTasksEditFieldsEn fields =
      TranslationsTasksEditFieldsEn._(_root);
  late final TranslationsTasksEditSubmitEn submit =
      TranslationsTasksEditSubmitEn._(_root);
  late final TranslationsTasksEditDeleteDialogEn deleteDialog =
...
class TranslationsSettingsThemeUseDynamicColorsOptionEn {
  ...
  String get subttileUnavailable =>
      'Dynamic colors aren\'t available on this platform';
}
...
class TranslationsSettingsThemeHarmonizeColorsEn {
  ...
  String get subtitle =>
      'All the custom colors would be more integrated into app theme';
}
...
class TranslationsTasksListAppBarActionsEn {
  ...
  // Translations
  late final TranslationsTasksListAppBarActionsPopupMenuEn popupMenu =
      TranslationsTasksListAppBarActionsPopupMenuEn._(_root);
}
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'settings.theme.title':
        return 'Theme';
      case 'settings.theme.useDynamicColorsOption.title':
        return 'Use dynamic colors';
      case 'settings.theme.useDynamicColorsOption.subtitle':
        return 'App\'s theme would adapt on system accent colors';
      case 'settings.theme.useDynamicColorsOption.subttileUnavailable':
        return 'Dynamic colors aren\'t available on this platform';
      case 'settings.theme.harmonizeColors.title':
        return 'Harmonized colors';
      case 'settings.theme.harmonizeColors.subtitle':
        return 'All the custom colors would be more integrated into app theme';
      ...
      case 'tasks.list.tooltips.addNewButton':
        return 'Add new task';
      case 'tasks.list.tooltips.canceledMarkButton':
        return 'Reopen';
      case 'tasks.list.tooltips.selectDateForSomedayTasksButton':
        return 'Select date for the task';
      case 'tasks.list.appBarActions.popupMenu.showCanceledOption':
        return 'Show canceled';
      case 'tasks.list.cancelButton':
        return 'Cancel tasks';
      case 'tasks.list.canceledTaskMark':
        return 'Canceled';
      case 'tasks.list.tasksLeftToComplete':
        return ({required num n}) =>
            (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(
              n,
              zero: 'No tasks left to complete',
      ...
      case 'tasks.list.empty.icon':
        return '¯\\_(ツ)_/¯';
      case 'tasks.list.empty.title':
        return 'There is no tasks';
      case 'tasks.list.empty.button':
        return 'Create a new one';
      case 'tasks.list.empty.titleFilters':
        return 'There is no tasks with such filters';
      case 'tasks.list.empty.buttonFilters':
        return 'Reset filters';
      case 'tasks.list.planning.labelWhenEnabled':
      ...
      case 'tasks.edit.fields.taskDescription':
        return 'Description';
      case 'tasks.edit.fields.taskForSomeday':
        return 'Someday';

...
class PlanViewBottomSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final (hasDescription, showCompletion) = ref.watch(
      featureTogglesConfigProvider.select(
        (value) => (
          value.features.contains(AppFeatures.plansDescription),
          value.features.contains(AppFeatures.showPlanCompletionCheckbox),
        ),
      ),
    );
